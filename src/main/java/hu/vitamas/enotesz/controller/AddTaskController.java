...
/**
 * Controller class of the task/add.fxml.
 * 
 * @author vitozy
 *
 */
public class AddTaskController implements Initializable {
	...
	static Logger logger = LoggerFactory.getLogger(AddTaskController.class);
	 ...
	 * 
	 * <p>Sets up the group and priority lists, and selects the first element of lists.
	 */
